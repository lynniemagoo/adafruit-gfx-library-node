...
class Adafruit_SPITFT extends Mixin_SPI_Display(Display_Base) {
    ...
    static SPI_Modes = SPI_MODES;
    static SPI_Defaults = SPI_DEFAULTS;

    async _preStartup() {
        const self = this;
        await self._hardwareStartup();
        await self._hardwareReset();
        return self;
    }
    ...
    */
    ...
    /*!
        ...
        @return Promise resolved with this.
    */
    /**********************************************************************/
    startWrite() {
