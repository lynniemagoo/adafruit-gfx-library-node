...
const Mixin_ThickLine = Base => class extends Base {


    constructor(options) {
        console.log("Mixin_ThickLine construct");
        super(options);
        const self = this;
...
module.exports = Mixin_ThickLine;
