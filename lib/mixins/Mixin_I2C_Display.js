...
const Mixin_I2C_Display = Base => class extends Base {
    ...
    constructor(options) {
        super(options);
        const self = this;
        _debug && console.log("I2C_Display_Mixin::constructor() begin");
        ...
        _debug && console.log("I2C_Display_Mixin::constructor() completed");
    }
    ...
    _hardwareReset() {
        _debug && console.log("I2C_Display_Mixin::_hardwareReset()");
        const self = this;
        if (self._rstGpio) {
            const doWork = async _ => {
        ...
        _debug && console.log("I2C_Display_Mixin::_hardwareReset() completed");
        return self;
    }
...
async function gpioHardwareReset_101(gpio) {
    const resetMs = 100;
    if (gpio) {
        _debug && console.log("gpioHardwareReset_101 execute!");
