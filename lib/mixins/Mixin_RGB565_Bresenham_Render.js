...
const Mixin_RGB565_Bresenham_Render = Base => class extends Base {
    ...
    /*!
        ...
        @param  options   object with 'thickness' and/or 'antialias' values
        @returns  this
    */
    /**************************************************************************/
    setDrawOptions({thickness = this.draw.thickness, antialias=this.draw.antialias} = {}) {
        if (thickness <= 0.0) throw new Error("thickness must be > 0");
        this.draw.thickness = thickness;
        this.draw.antialias = !! antialias;
        return this;
    }
    ...
    */
    ...
    /**************************************************************************/
    /*!
        @brief  Set the default drawing thickness.
        @param  thickness  - Default thickness used for drawing operations.
        @returns  this
    */
    /**************************************************************************/
    ...
    /**************************************************************************/
    /*!
        @brief  Get the default drawing thickness.
        @returns  Default thickness used for drawing operations.
    */
    /**************************************************************************/
    getDrawThickness() {
        return this.draw.thickness;
    }
    ...
    /*!
        ...
        @param    options {thickness = this.draw.thickness}
        @returns  this
    */
    /**************************************************************************/
    drawRect(x, y, w, h, color, {thickness = this.draw.thickness} = {}) {
        const self = this;
        let th = Math.floor(thickness + 0.5);
        while (--th >= 0) {
    ...
    /*!
        ...
        @param    color 16-bit 5-6-5 Color to draw with
        @param    options {thickness = this.draw.thickness, antialias = this.draw.antialias}
        @returns  this
    */
    /**************************************************************************/
    drawLine(x0, y0, x1, y1, color, {thickness = this.draw.thickness, antialias = this.draw.antialias} = {}) {
        const self = this;
        const th = thickness, aa = antialias;
        _debug && console.log("%s::drawLine(x0:%o, y0:%o, x1:%o, y1:%o, color565:%s, th:%o, aa:%o)", MODULE_NAME, x0, y0, x1, y1, toStringHexRGB565(color), th, aa);
        ...
        if (th == 1) {
            ...
            _debug && console.log("==>plotLineWidth(x0:%o, y0:%o, x1:%o, y1:%o, th:%o)", x0, x1, y0, y1, th);
            plotLineWidth(dc, x0, y0, x1, y1, th);
        }
        self.endWrite();
        return self;
    }
    ...
    */
    /**************************************************************************/
    drawCircle(xm, ym, r, color, {thickness = this.draw.thickness, antialias = this.draw.antialias} = {}) {
        return this.plotCircle(xm, ym, r, color, {thickness, antialias});
    }
    ...
    */
    /**************************************************************************/
    drawEllipse(xm, ym, rx, ry, color, {rotation = 0.0, thickness = this.draw.thickness, antialias = this.draw.antialias} = {}) {
        /*
        const x0 = xm - rx,
              y0 = ym - ry,
              x1 = xm + rx,
              y1 = ym + ry;
        return this.plotEllipseRect(x0, y0, x1, y1, color, {thickness, antialias});
        */
        return this.plotRotatedEllipse(xm, ym, rx, ry, rotation, color, {thickness, antialias});
    }
    ...
    */
    /**************************************************************************/
    drawRotatedEllipse(xm, ym, rx, ry, rad, color, {thickness = this.draw.thickness, antialias = this.draw.antialias} = {}) {
        return this.plotRotatedEllipse(xm, ym, rx, ry, rad, color, {thickness, antialias});
    }

    /**************************************************************************/
    /*!
        @brief    Draw an ellipse within a rectangle of specified thickness.
                  Clipping is responsibility of writePixel() implementation.
    ...
    */
    /**************************************************************************/
    drawEllipseRect(x0, y0, x1, y1, color, {thickness = this.draw.thickness, antialias = this.draw.antialias} = {}) {
        return this.plotEllipseRect(x0, y0, x1, y1, color, {thickness, antialias});
    }
    ...
    */
    /**************************************************************************/
    drawQuadraticBezier(x0, y0, x1, y1, x2, y2, color, {thickness = this.draw.thickness, antialias = this.draw.antialias} = {}) {
        return this.plotQuadraticBezier(x0, y0, x1, y1, x2, y2, color, {thickness, antialias});
    }
    ...
    */
    /**************************************************************************/
    drawQuadraticRationalBezier(x0, y0, x1, y1, x2, y2, weight, color, {thickness = this.draw.thickness, antialias = this.draw.antialias} = {}) {
        return this.plotQuadraticRationalBezier(x0, y0, x1, y1, x2, y2, weight, color, {thickness, antialias});
    }
    ...
    */
    /**************************************************************************/
    drawCubicBezier(x0, y0, x1, y1, x2, y2, x3, y3, color, {thickness = this.draw.thickness, antialias = this.draw.antialias} = {}) {
        return this.plotCubicBezier(x0, y0, x1, y1, x2, y2, x3, y3, color, {thickness, antialias});
    }
    ...
    */
    /**************************************************************************/
    plotCircle(xm, ym, r, color, {thickness = this.draw.thickness, antialias = this.draw.antialias} = {}) {
        const self = this;
        const th = thickness, aa = antialias;
        _debug && console.log("%s::plotCircle(xm:%o, ym:%o, r:%o, color565:%s, th:%o, aa:%o)", MODULE_NAME, xm, ym, r, toStringHexRGB565(color), th, aa);
        const dc = new DeviceContext(self, color);
        self.startWrite();
        if (!aa && (th == 1)) {
            ...
            const x0 = xm - r,
                  ...
                  x1 = xm + r,
                  y1 = ym + r;
            _debug && console.log("==>plotEllipseRectWidth(x0:%o, y0:%o, x1:%o, y1:%o, th:%o)", x0, y0, x1, y1, th);
            // if th < 1.5 plotEllipseRectWidth will use plotEllipsRectAA.
            plotEllipseRectWidth(dc, x0, y0, x1, y1, th);
        }
        self.endWrite();
        return self;
    }
    ...
    */
    /**************************************************************************/
    plotEllipseRect(x0, y0, x1, y1, color, {thickness = this.draw.thickness, antialias = this.draw.antialias} = {}) {
        const self = this;
        const th = thickness, aa = antialias;
        _debug && console.log("%s::drawEllipseRectWidth(x0:%o, y0:%o, x1:%o, y1:%o, color565:%s, th:%o, aa:%o)", MODULE_NAME, x0, y0, x1, y1, toStringHexRGB565(color), th, aa);
        const dc = new DeviceContext(self, color);
        self.startWrite();
        if (!aa && (th == 1)) {
    ...
    */
    /**************************************************************************/
    plotRotatedEllipse(xm, ym, rx, ry, rad, color, {thickness = this.draw.thickness, antialias = this.draw.antialias} = {}) {
        const self = this;
        const th = thickness, aa = antialias;
        _debug && console.log("%s::plotRotatedEllipse(xm:%o, ym:%o, rx:%o, ry:%o, rad:%o color565:%s, th:%o, aa:%o)", MODULE_NAME, xm, ym, rx, ry, rad, toStringHexRGB565(color), th, aa);
        const dc = new DeviceContext(self, color);
        self.startWrite();
        if (!aa && (th == 1)) {
            ...
            if (th == 1) {
                ...
                _debug && console.log("==>plotRotatedEllipseWidth(xm:%o, ym:%o, rx:%o, ry:%o, rad:%o th:%o)", xm, ym, rx, ry, rad, th);
                plotRotatedEllipseWidth(dc, xm, ym, rx, ry, rad, th);
            }
        }
        self.endWrite();
        return self;
    ...
    */
    /**************************************************************************/
    plotQuadraticBezier(x0, y0, x1, y1, x2, y2, color, {thickness = this.draw.thickness, antialias = this.draw.antialias} = {}) {
        const self = this;
        const th = thickness, aa = antialias;
        _debug && console.log("%s::plotQuadraticBezier(x0:%o, y0:%o, x1:%o, y1:%o, x2:%o, y2:%o, color565:%s, th:%o, aa:%o)", MODULE_NAME, x0, y0, x1, y1, x2, y2, toStringHexRGB565(color), th, aa);
        const dc = new DeviceContext(self, color);
        self.startWrite();
        if (th == 1) {
            if (!aa) {
            ...
            const weight = 1;
            _debug && console.log("==>plotQuadRationalBezierWidth(x0:%o, y0:%o, x1:%o, y1:%o, x2:%o, y2:%o, weight:%o, th:%o)", x0, y0, x1, y1, x2, y2, weight, th);
            plotQuadRationalBezierWidth(dc, x0, y0, x1, y1, x2, y2, weight, th);
        }
        self.endWrite();
        return self;
    }
    ...
    */
    /**************************************************************************/
    plotQuadraticRationalBezier(x0, y0, x1, y1, x2, y2, weight, color, {thickness = this.draw.thickness, antialias = this.draw.antialias} = {}) {
        const self = this;
        const th = thickness, aa = antialias;
        _debug && console.log("%s::plotQuadraticBezier(x0:%o, y0:%o, x1:%o, y1:%o, x2:%o, y2:%o, weight:%o, color565:%s, th:%o, aa:%o)", MODULE_NAME, x0, y0, x1, y1, x2, y2, weight, toStringHexRGB565(color), th, aa);
        const dc = new DeviceContext(self, color);
        self.startWrite();
        if (th == 1) {
            if (!aa) {
                _debug && console.log("==>plotQuadRationalBezier(x0:%o, y0:%o, x1:%o, y1:%o, x2:%o, y2:%o, weight:%o)", x0, y0, x1, y1, x2, y2, weight);
                plotQuadRationalBezier(dc, x0, y0, x1, y1, x2, y2, weight);
            } else {
                _debug && console.log("==>plotQuadRationalBezierAA(x0:%o, y0:%o, x1:%o, y1:%o, x2:%o, y2:%o, weight:%o)", x0, y0, x1, y1, x2, y2, weight);
    ...
    */
    /**************************************************************************/
    plotCubicBezier(x0, y0, x1, y1, x2, y2, x3, y3, color, {thickness = this.draw.thickness, antialias = this.draw.antialias} = {}) {
        const self = this;
        const th = thickness, aa = antialias;
        _debug && console.log("%s::plotCubicBezier(x0:%o, y0:%o, x1:%o, y1:%o, x2:%o, y2:%o, x3:%o, y3:%o, color565:%s, th:%o, aa:%o)", MODULE_NAME, x0, y0, x1, y1, x2, y2, x3, y3, toStringHexRGB565(color), th, aa);
        const dc = new DeviceContext(self, color);
        self.startWrite();
        if (th == 1) {
            if (!aa) {
            ...
            const weight = 1;
            _debug && console.log("==>plotCubicBezierWidth(x0:%o, y0:%o, x1:%o, y1:%o, x2:%o, y2:%o, x3:%o, y3:%o, th:%o)", x0, y0, x1, y1, x2, y2, x3, y3, th);
            plotCubicBezierWidth(dc, x0, y0, x1, y1, x2, y2, x3, y3, th);
        }
        self.endWrite();
        return self;
    }
    ...
    */
    /**************************************************************************/
    /*
    plotEllipse(xm, ym, rx, ry, color, {thickness = this.draw.thickness, antialias = this.draw.antialias} = {}) {
        const self = this;
        const th = thickness, aa = antialias;
        _debug && console.log("%s::plotEllipse(xm:%o, ym:%o, rx:%o, ry:%o, color565:%s, th:%o aa:%o)", MODULE_NAME, xm, ym, rx, ry, toStringHexRGB565(color), th, aa);
        const dc = new DeviceContext(self, color);
        const x0 = xm - rx,
              y0 = ym - ry,
              x1 = xm + rx,
        ...
        if (!aa && (th == 1)) {
            ...
            _debug && console.log("==>plotEllipseRectWidth(x0:%o, y0:%o, x1:%o, y1:%o, th:%o)", x0, y0, x1, y1, th);
            // if th < 1.5 plotEllipseRectWidth will use plotEllipsRectAA.
            plotEllipseRectWidth(dc, x0, y0, x1, y1, tg);
        }
        self.endWrite();
        return self;
    }
