...
const Mixin_RGB565_Bresenham_Render = Base => class extends Base {
    ...
    /**************************************************************************/
    /*!
        @brief  Set the default pen antialias value for drawing operations.
        @param  aFlag   Boolean value true or false.
        @returns  this
    */
    /**************************************************************************/
    setPenAntialias(aFlag) {
        const self = this;
        self.pen.antialias = !! aFlag;
        return self;
    }

    /**************************************************************************/
    /*!
        @brief  get the default pen antialias value for drawing operations.
        @returns  Boolean value true or false.
    */
    /**************************************************************************/
    getPenAntialias() {
        return this.pen.antialias;
    }

    
    /**************************************************************************/
    /*!
        @brief  Set the default pen width for drawing operations.
        @param  pen_width  - Default width used for drawing operations.
        @returns  this
    */
    /**************************************************************************/
    setPenWidth(width) {
    ...
    /**************************************************************************/
    /*!
        @brief  get the default pen width for drawing operations.
    ...
    */
    ...
    /*!
        ...
        @param    options {width = this.pen.width, antialias = this.pen.antialias}
        @returns  this
    */
    /**************************************************************************/
    drawLine(x0, y0, x1, y1, color, {width = this.pen.width, antialias = this.pen.antialias} = {}) {
        const self = this;
    ...
    */
    /**************************************************************************/
    drawCircle(xm, ym, r, color, {width = this.pen.width, antialias = this.pen.antialias} = {}) {
    ...
    */
    /**************************************************************************/
    drawEllipse(xm, ym, rx, ry, color, {rotation = 0.0, width = this.pen.width, antialias = this.pen.antialias} = {}) {
        /*
        const x0 = xm - rx,
              y0 = ym - ry,
              x1 = xm + rx,
    ...
    */
    /**************************************************************************/
    drawRotatedEllipse(xm, ym, rx, ry, rad, color, {width = this.pen.width, antialias = this.pen.antialias} = {}) {
    ...
    */
    /**************************************************************************/
    drawEllipseRect(x0, y0, x1, y1, color, {width = this.pen.width, antialias = this.pen.antialias} = {}) {
        return this.plotEllipseRect(x0, y0, x1, y1, color, {width, antialias});
    }
    ...
    */
    /**************************************************************************/
    drawLineOrig(x0, y0, x1, y1, color, antialias = this.pen.antialias) {
        const self = this;
        const aa = antialias;
        _debug && console.log("%s::drawLine(x0:%o, y0:%o, x1:%o, y1:%o, color565:%s, aa:%o)", MODULE_NAME, x0, y0, x1, y1, toStringHexRGB565(color) , aa);
        const dc = new DeviceContext(self, color);
    ...
    */
    /**************************************************************************/
    plotCircle(xm, ym, r, color, {width = this.pen.width, antialias = this.pen.antialias} = {}) {
        const self = this;
        const w = width, aa = antialias;
    ...
    */
    /**************************************************************************/
    plotEllipseRect(x0, y0, x1, y1, color, {width = this.pen.width, antialias = this.pen.antialias} = {}) {
        const self = this;
        const w = width, aa = antialias;
    ...
    /*!
        ...
        @param    color 16-bit 5-6-5 Color to draw with
        @param    options {radians = 0, width = this.pen.width, antialias = this.pen.antialias}
        @returns  this
    */
    /**************************************************************************/
    plotRotatedEllipse(xm, ym, rx, ry, rad, color, {width = this.pen.width, antialias = this.pen.antialias} = {}) {
        const self = this;
        const w = width, aa = antialias;
        _debug && console.log("%s::drawEllipseRectWidth(xm:%o, ym:%o, rx:%o, ry:%o, rad:%o color565:%s, w:%o, aa:%o)", MODULE_NAME, x0, y0, rx, ry, rad, toStringHexRGB565(color), w, aa);
        const dc = new DeviceContext(self, color);
        self.startWrite();
        if (!aa && (w == 1)) {
    ...
    */
    /**************************************************************************/
    /*
    plotEllipse(xm, ym, rx, ry, color, {width = this.pen.width, antialias = this.pen.antialias} = {}) {
        const self = this;
        const w = width, aa = antialias;
